	...
	<div id="navBig">
		<div id="navSmall">
			...
			<ul>
				...
				<li><a class="true" href="even1.jsp"></a>
				</li>
	...
	<div id="contentBox">
		<div id="contentSmall">
			<div class="list">
				<h2>真实案例</h2>
				<ul>
					<li class="title">新闻客户端</li>
					<li class="liContent"><a href="even1.jsp">详情</a>
					</li>
				</ul>
				<ul>
					<li class="title">外卖客户端</li>
					<li class="liContent" id="having"><a href="even2.jsp">详情</a>
					</li>
				</ul>
			</div>
			<div class="content">
				<h3>简介</h3>
				<div class="contentP">
					<P>移动开发案例之外卖客户端，利用云数据操纵助手，开发类似产品及其方便简单。
						您只需专注于安卓客户端的开发，专注于业务的运营！</P>
					<p>
						<img src="../images/even-3.jpg" width="338" height="600" />
					</p>
				</div>
				<h3>代码实现</h3>
				<div class="contentP">
					<P>如果您还没有Token和云数据库，请参见"帮助与支持"</P>
					<p>
						<img src="../images/even-4.png" width="626" height="309" />
					</p>
					<p>代码实例</p>
					<p style="border:#CCC solid 1px;">
						<img src="../images/even-5.png" width="546" height="372" />
					</p>
				</div>
			</div>
		</div>
