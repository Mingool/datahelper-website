...
<script type="text/javascript" src="js/xuanxiangka.js"></script>
<script type="text/javascript">
	function login(){
		var mForm = document.getElementsByName("login_form").item(0);
		mForm.submit();
	}
</script>
</head>
...
<body>
	...
	<div id="loginBox">
		<div class="login">
			<form action="${pageContext.request.contextPath }/developer/login.action" name="login_form" method="post" id="myForm" style="height:100px;">
				<div class="input">
					<input type="text" name="username" maxlength="16" id="useName"/>
				</div>
				<div class="input">
					<input class="inputP" type="password" name="password" maxlength="12" id="password" /> <input
						type="checkbox" name="" value="" id="y" checked="checked" /> <span>我已经同意了<a
						href="about/about2.jsp">《云数据操纵助手章程》</a> </span>
				</div>
			</form>
			<div id="return"></div>
			<div>
				<a class="enter" href="javascript:login(); onclick=validate()"></a>
			</div>
			<h2>
				<a href="javascript:void(0)">忘了密码？</a><span> | </span><a
					href="register.jsp">注册新账号</a><span> | </span><a
					href="javascript:void(0)">意见反馈</a>
			</h2>
		</div>
	</div>
	<div id="warning">
		<ul>
			<li class="warningPicture"><img src="images/warningPicture.png"
				width="18" height="14" />
			</li>
			<li><a href="help/help1.jsp">移动平台开发的终极解决方案</a>
			</li>
			<li><a href="help/help1.jsp">隶属于211名校河北工业大学</a>
			</li>
			<li><a href="help/help1.jsp">一键调用SDK，开发从此变得简便</a>
			</li>
		...
		<ul>
			...
			<li class="content" id="c_1" onmouseover="c_kua()"><a
				href="help/help1.jsp">
					...
					<p class="advPicture">
						<img src="images/adv-3.png" width="60" height="60" />
					</p>
					<p class="smallSize">提供Java平台JDK</p> </a></li>
			<li class="content2" id="c-1"><a href="help/help1.jsp">
					<p class="bigSize">跨平台性</p>
					<p class="smallSize">
						我们的SDK采用java语言编写<br /> 您可以在任何java环境下使用我们的产品
					</p> </a> <a href="help/help1.jsp" class="white">立即查看</a></li>
			<li class="content" id="c_2" onmouseover="c_jie()"><a
				href="help/help1.jsp">
					<p class="bigSize">接口统计</p>
					<p class="advPicture">
						<img src="images/adv-4.png" width="60" height="60" />
					</p>
					<p class="smallSize">用户接口访问统计</p> </a></li>
			<li class="content2" id="c-2"><a href="help/help1.jsp">
					<p class="bigSize">接口统计</p>
					<p class="smallSize">
			...
			<li class="content" id="c_3" onmouseover="c_fu()"><a
				href="help/help1.jsp">
					...
					<p class="advPicture">
						<img src="images/adv-1.png" width="60" height="60" />
					</p>
					<p class="smallSize">DBCP数据源解决高并发</p> </a></li>
			<li class="content2" id="c-3"><a href="help/help1.jsp">
					<p class="bigSize">负载均衡</p>
					<p class="smallSize">
			...
			<li class="content" id="c_4" onmouseover="c_yun()"><a
				href="help/help1.jsp">
					...
					<p class="advPicture">
						<img src="images/adv-2.png" width="60" height="60" />
					</p>
					<p class="smallSize">支持MYSQL数据库</p> </a></li>
			<li class="content2" id="c-4"><a href="help/help1.jsp">
					<p class="bigSize">云数据库</p>
					<p class="smallSize">
			...
			<li class="other" id="o_1" onmouseover="o_yun()">
				...
				<p class="otherTitle">
					<img src="images/adv-5.png" width="18" height="20" />云盾
				</p>
				<p class="p1">接口警报</p>
				<p class="p2">更多模块正在开发中，敬请期待</p> </a></li>
			<li class="other2" id="o-1"><a href="help/help1.jsp">
					<p class="otherTitle">
						<img src="images/adv-8.png" width="18" height="20" />云盾
					</p>
					<p class="p1">接口警报</p>
					<p class="p2">更多模块正在开发中，敬请期待</p> </a> <a href="help/help1.jsp"
	...
	<div id="contact">
		...
		<span><img src="images/contact-1.png" width="19" height="19" />18002137253</span>
		<span><img src="images/contact-2.png" width="19" height="20" />2862460298</span>
	</div>
	<div id="footer">
		<p class="footer1">
