		...
		<div id="contentSmall">
			<div class="list">
				...
				<ul>
					...
					<li class="liContent" id="having"><a href="help2.jsp">Demo</a>
					</li>
				</ul>
				<ul>
					<li class="title">API</li>
					<li class="liContent"><a href="help3.jsp">FexUtils</a>
					</li>
			...
			<div class="content">
				<h3>QuickStart</h3>
				<div class="contentP">
					<p>在您注册成为开发者并登录后，在"基本信息"栏目可以查看您
						的Token,如果您没有Token,可以立即在线申请。得到Token后，您 可以在程序中测试SDK。如图所示。</p>
					<p>
						<img src="../images/help-4.png" width="769" height="504" />
					</p>
					<p>若网络连接出现问题或者网络延迟造成的访问失败，SDK框架会抛出
						InternetConnectionException异常。</p>
					<p>若DQL类型的SQL语句执行成功，会返回List&ltMap&ltString,Object&gt&gt类型。
						其中，数据表中的一行数据对应一个Map，一个javaBean，而数据表中 每一列的数据对应着每个Map中的元素。</p>
					<p>在得到List&ltMap&ltString,Object&gt&gt之后，您可以使用如下方法遍历元素</p>
					<p>
						<img src="../images/help-5.png" width="664" height="171" />
					</p>
					<p>后期我们会更新SDK，逐步丰富SDK的功能</p>
				</div>
				<h3>成功</h3>
				<div class="contentP">
					<p>测试成功后，开启您的开发之旅！</p>
