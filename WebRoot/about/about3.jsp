...
<body>
	<div id="navBig">
		<div id="navSmall">
			...
			<ul>
				...
				<li><a class="about" href="about1.jsp"></a>
				</li>
			</ul>
		</div>
	</div>
	<div id="contentBox">
		<div id="contentSmall">
			<div class="list">
				<h2>关于云操纵</h2>
				<ul>
					<li><a href="about1.jsp">关于我们</a>
					</li>
					<li><a href="about2.jsp">法律声明</a>
					</li>
					<li class="li"><a href="about3.jsp">友情链接</a>
					</li>
				</ul>
			</div>
			<div class="content">
				...
				<div class="contentP2">
					<p>
						<a href="http://www.hebut.edu.cn/" target="_blank">河北工业大学</a>
					</p>
					<p>
						<a href="http://jwc.hebut.edu.cn/" target="_blank">教务处</a>
					</p>
					<p>
						<a href="http://xyh.hebut.edu.cn/xyw/" target="_blank">校友网</a>
					</p>
					<p>
						<a href="http://xchb.hebut.edu.cn/main.asp?tid=3" target="_blank">媒体工大</a>
					</p>
					<p>
						<a href="http://xsc.hebut.edu.cn/jiuye/index.asp" target="_blank">就业网</a>
					</p>
					<p>
						<a href="http://oa.hebut.edu.cn/index.htm" target="_blank">办公网</a>
					</p>
					<p>
						<a href="http://tm.hebut.edu.cn/CivilEngineering/index.jsp"
							target="_blank">土木工程学院</a>
					</p>
					<p>
						<a href="http://219.243.86.235/" target="_blank">控制学院</a>
					</p>
					<p>
						<a href="http://clxy.hebut.edu.cn/" target="_blank">材料学院</a>
					</p>
					<p>
						<a href="http://www.scse.hebut.edu.cn/" target="_blank">计算机学院</a>
					</p>
					<p>
						<a href="http://jyxy.hebut.edu.cn/" target="_blank">建艺学院</a>
					</p>
					<p>
						<a href="http://115.24.160.162/" target="_blank">教务系统</a>
					</p>
				</div>
			</div>
		</div>
	...
	<div id="footer">
		<p class="footer1">
			<a href="about1.jsp" target="_blank">关于我们</a> <a href="about2.jsp"
				target="_blank">法律声明</a> <a href="about3.jsp" target="_blank">友情链接</a>
		</p>
		<p class="footer2">
